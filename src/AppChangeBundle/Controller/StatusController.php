...
use AppChangeBundle\Entity\Status;
use AppChangeBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppChangeBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("AppChangeBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppChangeBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppChangeBundle:Status:edit.html.twig")
     */
