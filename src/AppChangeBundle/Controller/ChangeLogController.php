...
use AppChangeBundle\Entity\ChangeLog;
use AppChangeBundle\Form\ChangeLogType;
...
class ChangeLogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppChangeBundle:ChangeLog')->findAll();
     ...
     * @Method("POST")
     * @Template("AppChangeBundle:ChangeLog:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('changelog_show', array('id' => $entity->getId())));
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppChangeBundle:ChangeLog')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppChangeBundle:ChangeLog:edit.html.twig")
     */
