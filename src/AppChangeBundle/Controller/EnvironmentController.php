...
use AppChangeBundle\Entity\Environment;
use AppChangeBundle\Form\EnvironmentType;
...
class EnvironmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppChangeBundle:Environment')->findAll();
     ...
     * @Method("POST")
     * @Template("AppChangeBundle:Environment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppChangeBundle:Environment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppChangeBundle:Environment:edit.html.twig")
     */
