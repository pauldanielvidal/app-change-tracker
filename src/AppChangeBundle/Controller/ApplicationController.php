...
use AppChangeBundle\Entity\Application;
use AppChangeBundle\Form\ApplicationType;
...
class ApplicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppChangeBundle:Application')->findAll();
     ...
     * @Method("POST")
     * @Template("AppChangeBundle:Application:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppChangeBundle:Application')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppChangeBundle:Application:edit.html.twig")
     */
